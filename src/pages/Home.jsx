  ...
  return (
    <div class="space-y-32 pb-20">
      <section class="relative h-screen flex items-center justify-center overflow-hidden bg-black">
        ...
        <div class="relative z-10 text-center text-white px-8 py-12 space-y-6 bg-black/40 backdrop-blur-sm rounded-2xl max-w-4xl mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-16">
          {[1, 2, 3].map((i) => (
            <div class="animate-on-scroll opacity-0 translate-y-10 transition-all duration-1000 flex flex-col items-center text-center group" style={{ transitionDelay: `${i * 200}ms` }}>
              <div class="w-full aspect-[3/4] overflow-hidden rounded-2xl mb-8 border border-brown/10 shadow-lg group-hover:shadow-2xl transition-all duration-500">
